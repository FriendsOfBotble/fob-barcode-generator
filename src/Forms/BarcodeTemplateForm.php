...
class BarcodeTemplateForm extends FormAbstract
{
    public function setup(): void
    {
        $this
            ...
            ->add('name', TextField::class, TextFieldOption::make()->label(trans('plugins/fob-barcode-generator::barcode-generator.templates.name'))->required())
            ->add('description', TextareaField::class, TextareaFieldOption::make()->label(trans('plugins/fob-barcode-generator::barcode-generator.templates.description')))
            ->add('paper_size', SelectField::class, SelectFieldOption::make()
            ...
            ->add('orientation', SelectField::class, SelectFieldOption::make()
                ...
                ->required())
            ->addOpenCollapsible('dimensions', 'Label Dimensions')
            ->add('label_width', NumberField::class, NumberFieldOption::make()
                ->label(trans('plugins/fob-barcode-generator::barcode-generator.settings.label_width'))
                ->attributes(['step' => '0.1', 'min' => '10', 'max' => '200'])
                ->required())
            ->add('label_height', NumberField::class, NumberFieldOption::make()
                ->label(trans('plugins/fob-barcode-generator::barcode-generator.settings.label_height'))
                ->attributes(['step' => '0.1', 'min' => '10', 'max' => '200'])
                ->required())
            ->add('margin_top', NumberField::class, NumberFieldOption::make()
                ->label('Margin Top (mm)')
                ->attributes(['step' => '0.1', 'min' => '0', 'max' => '50']))
            ->add('margin_bottom', NumberField::class, NumberFieldOption::make()
                ->label('Margin Bottom (mm)')
                ->attributes(['step' => '0.1', 'min' => '0', 'max' => '50']))
            ->add('margin_left', NumberField::class, NumberFieldOption::make()
                ->label('Margin Left (mm)')
                ->attributes(['step' => '0.1', 'min' => '0', 'max' => '50']))
            ->add('margin_right', NumberField::class, NumberFieldOption::make()
                ->label('Margin Right (mm)')
                ->attributes(['step' => '0.1', 'min' => '0', 'max' => '50']))
            ->add('padding', NumberField::class, NumberFieldOption::make()
                ->label('Padding (mm)')
                ->attributes(['step' => '0.1', 'min' => '0', 'max' => '20']))
            ->addCloseCollapsible('dimensions')
            ->addOpenCollapsible('layout', 'Page Layout')
            ->add('columns_per_page', NumberField::class, NumberFieldOption::make()
                ->label(trans('plugins/fob-barcode-generator::barcode-generator.settings.columns_per_page'))
                ->attributes(['min' => '1', 'max' => '10'])
                ->required())
            ->add('rows_per_page', NumberField::class, NumberFieldOption::make()
                ->label(trans('plugins/fob-barcode-generator::barcode-generator.settings.rows_per_page'))
                ->attributes(['min' => '1', 'max' => '20'])
                ->required())
            ->addCloseCollapsible('layout')
            ->addOpenCollapsible('barcode', 'Barcode Settings')
            ->add('barcode_type', SelectField::class, SelectFieldOption::make()
                ...
                ->required())
            ->add('barcode_width', NumberField::class, NumberFieldOption::make()
                ->label('Barcode Width (mm)')
                ->attributes(['step' => '0.1', 'min' => '10', 'max' => '200'])
                ->required())
            ->add('barcode_height', NumberField::class, NumberFieldOption::make()
                ->label('Barcode Height (mm)')
                ->attributes(['step' => '0.1', 'min' => '5', 'max' => '100'])
                ->required())
            ->add('include_text', CheckboxField::class, CheckboxFieldOption::make()
                ->label(trans('plugins/fob-barcode-generator::barcode-generator.settings.include_text')))
            ->add('text_position', SelectField::class, SelectFieldOption::make()
            ...
            ->add('text_size', NumberField::class, NumberFieldOption::make()
                ->label(trans('plugins/fob-barcode-generator::barcode-generator.settings.text_size'))
                ->attributes(['min' => '6', 'max' => '20']))
            ->addCloseCollapsible('barcode')
            ->add('is_default', CheckboxField::class, CheckboxFieldOption::make()
