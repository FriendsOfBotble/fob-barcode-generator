...
@push('header')
    <link rel="stylesheet" href="{{ asset('vendor/core/plugins/fob-barcode-generator/css/barcode-generator.css') }}">
@endpush

@push('footer')
    <script src="{{ asset('vendor/core/plugins/fob-barcode-generator/js/barcode-generator.js') }}"></script>
    <script>
        window.BarcodeGeneratorConfig = {
            routes: {
                generate: '{{ route('marketplace.vendor.barcode-generator.generate') }}',
                preview: '{{ route('marketplace.vendor.barcode-generator.preview') }}'
            },
            messages: {
